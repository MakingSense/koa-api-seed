...
class UserEmailService {
    async sendForgotPassword(user, code, details = DEFAULT_REQUEST_DETAILS) {
        ...
        Logger.log("info", "[Users] [Email Service] [Forgot Pass Email] Reset password email sent successfully", {
            user,
            details
        });
        return res;
    ...
    async sendPasswordChanged(user, details = DEFAULT_REQUEST_DETAILS) {
        ...
        Logger.log("info", "[Users] [Email Service] [Password Changed Email] Password changed email sent successfully", {
            user,
            details
        });
        return res;
